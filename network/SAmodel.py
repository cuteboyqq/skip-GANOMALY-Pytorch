...
from network.SAnetwork import SANetG, SANetD, weights_init
from network.loss import l2_loss




class SAGanomaly(nn.Module):
    """GANomaly Class
    """
    ...
    def __init__(self,args):
        ...
        super(SAGanomaly, self).__init__()
        ...
        self.netg = SANetG(self.isize,self.nc,self.nz).to(self.device)
        self.netd = SANetD(self.isize,self.nc).to(self.device)
